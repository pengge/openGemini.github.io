import{_ as n,X as s,Y as a,a3 as e}from"./framework-a5f096d1.js";const t={},l=e(`<h1 id="minimal-deployment-topology" tabindex="-1"><a class="header-anchor" href="#minimal-deployment-topology" aria-hidden="true">#</a> Minimal deployment topology</h1><p>This document describes the minimal deployment topology of openGemini clusters.</p><h2 id="topology-information" tabindex="-1"><a class="header-anchor" href="#topology-information" aria-hidden="true">#</a> Topology information</h2><table><thead><tr><th style="text-align:left;">Instance</th><th style="text-align:left;">Count</th><th style="text-align:left;">Physical machine configuration</th><th style="text-align:left;">IP</th><th style="text-align:left;">Configuration</th></tr></thead><tbody><tr><td style="text-align:left;">ts-sql</td><td style="text-align:left;">4</td><td style="text-align:left;">16 VCore 32 GiB 100 GiB for storage</td><td style="text-align:left;">192.168.1.1 192.168.1.2 192.168.1.3 192.168.1.4</td><td style="text-align:left;">Default port Global directory configuration</td></tr><tr><td style="text-align:left;">ts-meta</td><td style="text-align:left;">3</td><td style="text-align:left;">4 VCore 8 GiB 100 GiB for storage</td><td style="text-align:left;">192.168.1.1 192.168.1.2 192.168.1.3</td><td style="text-align:left;">Default port Global directory configuration</td></tr><tr><td style="text-align:left;">ts-store</td><td style="text-align:left;">4</td><td style="text-align:left;">16 VCore 32 GiB 2 TiB (NVMe SSD) for storage</td><td style="text-align:left;">192.168.1.1 192.168.1.2 192.168.1.3 192.168.1.4</td><td style="text-align:left;">Default port Global directory configuration</td></tr></tbody></table><h2 id="topology-templates" tabindex="-1"><a class="header-anchor" href="#topology-templates" aria-hidden="true">#</a> Topology templates</h2><details><summary>minimal config template</summary><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">global</span><span class="token punctuation">:</span>
