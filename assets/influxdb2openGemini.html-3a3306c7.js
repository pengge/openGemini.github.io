import{_ as t,X as a,Y as s,Z as e,a1 as i,$ as d,a3 as r,C as l}from"./framework-a5f096d1.js";const o={},c=e("h2",{id:"仓库地址",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#仓库地址","aria-hidden":"true"},"#"),i(" 仓库地址")],-1),u={href:"https://github.com/openGemini/data-migration-tools",target:"_blank",rel:"noopener noreferrer"},v=r(`<p>工具名称是 dataMigrate。 它用于将 InfluxDB 数据迁移到 openGemini。 dataMigrate直接从InfluxDB的TSM文件中读取数据写入openGemini。</p><div class="hint-container tip"><p class="hint-container-title">Tips</p><p>如果源数据库的表存在上千字段时，该工具需要更大的内容，因为在内部要把所有列读取后再组装成行再写入openGemini，这部分比较耗内存资源</p></div><h2 id="快速开始" tabindex="-1"><a class="header-anchor" href="#快速开始" aria-hidden="true">#</a> 快速开始</h2><ul><li><strong>环境信息</strong> Go version &gt;1.16</li></ul><p>Setting Environment Variables</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&gt; export GOPATH=/path/to/dir
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,11);function m(p,g){const n=l("ExternalLinkIcon");return a(),s("div",null,[c,e("p",null,[e("a",u,[i("data-migration-tools"),d(n)])]),v])}const h=t(o,[["render",m],["__file","influxdb2openGemini.html.vue"]]);export{h as default};
